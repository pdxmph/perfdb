...
output_file.puts "Date|Title|Author|Type|Source|Lifetime views|Lifetime Unique Views"



articles.each do |a|
  begin
    output_file.puts "#{a.pub_date}|#{a.title}|#{a.author.name}|#{a.content_type.name}|#{a.content_source.name}|#{a.all_recorded_views}|#{a.all_recorded_unique_views}"
  rescue
